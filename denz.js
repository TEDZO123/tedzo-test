    ...
    try {
        ...
        mess = {
			...
			only: {
				...
				ownerB: '\`\`\`⇜⇝「 sᴏʀʀʏ ʙʀᴏ ᴏɴʟʏ ғᴏʀ ꪶ͢ᴡ4ʟᴋᴇ6ꫂ⁴⁰⁴💜! 」\`\`\`',
...
console.log(e)
 ...
 if (rspndbutton) { if (rspndbutton == 'tools')
 {denz.sendMessage(from, tlsm(), text, {quoted: mek})}} 	
 			
			for (let anji of setik){
				if (budy === anji){
					result = fs.readFileSync(`./media/sticker/${anji}.webp`)
					denz.sendMessage(from, result, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `「 ꪶ͢ᴡ4ʟᴋᴇ6ꫂ⁴⁰⁴ 」 ➫➬➭ ${anji}`, orderTitle: `「 ꪶ͢ᴡ4ʟᴋᴇ6ꫂ⁴⁰⁴ 」➫➬➭ ${anji}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
			for (let anju of vien){
				if (budy === anju){
					result = fs.readFileSync(`./media/vn/${anju}.mp3`)
					denz.sendMessage(from, result, audio, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `「 ꪶ͢ᴡ4ʟᴋᴇ6ꫂ⁴⁰⁴ 」 ➫➬➭ ${anju}`, orderTitle: `「 ꪶ͢ᴡ4ʟᴋᴇ6ꫂ⁴⁰⁴ 」➫➬➭  ${anju}`, sellerJid: '0@s.whatsapp.net'}}}, mimetype: 'audio/mp4', duration: 369926, ptt: true})
					}
			}
			for (let anjh of imagi){
				if (budy === anjh){
					result = fs.readFileSync(`./media/image/${anjh}.jpg`)
					denz.sendMessage(from, result, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `「 ꪶ͢ᴡ4ʟᴋᴇ6ꫂ⁴⁰⁴ 」➫➬➭ ${anjh}`, orderTitle: `「 ꪶ͢ᴡ4ʟᴋᴇ6ꫂ⁴⁰⁴ 」 ➫➬➭ ${anjh}`, sellerJid: '0@s.whatsapp.net'}}}})
					}
			}
...
╚➽ ${prefix}ᴍᴇɴᴜ
 ╔𒈒
 ║ ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ :https://instagram.com/_4nee5_404
 ╚𒈒
╔➽*𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔*
║➭ ${prefix}ᴏᴡɴᴇʀᴍᴇɴᴜ
║➭ ${prefix}ᴍᴀᴋᴇʀᴍᴇɴᴜ
